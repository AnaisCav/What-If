...
const Toggle = ({
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center" tabIndex={5}>
      ...
      <div className="flex flex-col items-center" tabIndex={6}>
      ...
      <div className="flex flex-col items-center" tabIndex={7}>
      ...
      <div className="flex flex-col items-center" tabIndex={8}>
